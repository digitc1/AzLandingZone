Function setup-Lighthouse {
    ...
    $definitionManagedServices = "https://raw.githubusercontent.com/digitc1/AzLandingZonePublic/master/LandingZone/definitions/lighthouse/definition-managedServices.json"
